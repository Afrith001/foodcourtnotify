...
import { A as Send, C as Star, Dt as CircleX, Ft as ChevronDown, Gt as Award, It as ChefHat, L as Quote, Lt as Check, Nt as ChevronRight, O as ShieldCheck, Ot as CircleQuestionMark, Pt as ChevronLeft, Q as MessageCircle, T as Smartphone, Ut as BookOpen, V as Phone, at as Mail, bt as Eye, dt as Image, et as Megaphone, gt as Globe, ht as Hash, it as MapPin, m as Trophy, n as X, p as Twitter, st as LoaderCircle, t as Youtube, tt as Maximize2, u as User, ut as Instagram, v as Target, w as Sparkles, yt as Facebook } from "../_libs/lucide-react.mjs";
import { t as optimizedImageUrl } from "./images-BnAPhdvv.mjs";
import { n as formatCurrency } from "./pos-BKnCkGZE.mjs";
import { a as normalizeOrderId, i as normalizeMobile, t as findOrderByPublicId } from "./order-utils-CFPxZ7kp.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/order._shopCode-BIx1c-eu.js
...
function CustomerPortal() {
	...
	const estimatedMinutes = (0, import_react.useMemo)(() => {
		...
		const computed = order.items.reduce((sum, item) => sum + (item.preparationTime ?? 0) * (item.quantity || 1), 0);
