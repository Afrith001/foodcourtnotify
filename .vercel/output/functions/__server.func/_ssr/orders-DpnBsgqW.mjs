...
import { C as onSnapshot, M as doc, O as updateDoc, T as query, j as collection, k as where, w as orderBy } from "../_libs/@firebase/firestore+[...].mjs";
...
import { D as Smartphone, H as Printer, Mt as Clock, N as Search, u as User, wt as Funnel, z as Receipt } from "../_libs/lucide-react.mjs";
...
import { c as startOfDay, i as format, n as isBefore, r as isAfter, s as endOfDay, t as subDays } from "../_libs/date-fns.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/orders-DpnBsgqW.js
...
function OrdersPage() {
	...
	const advanceOrder = async (id, nextStatus) => {
		try {
			...
			await updateDoc(doc(getDb(), COL.orders, id), {
				status: nextStatus,
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
								...
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableBody, { children: [filteredOrders.map((o) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
								...
								}, o.id)), !filteredOrders.length && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableRow, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
									colSpan: 6,
