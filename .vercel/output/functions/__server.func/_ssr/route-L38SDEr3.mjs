...
import { a as getFirebaseAuth, i as getFirebaseApp, n as firebaseConfigured, r as getDb, t as COL } from "./firebase-jX9Hxz-N.mjs";
import { u as require_react } from "../_libs/@floating-ui/react-dom+[...].mjs";
import { s as require_jsx_runtime } from "../_libs/@radix-ui/react-arrow+[...].mjs";
import { i as useShopState, n as useAuth, r as useShop, t as ShopProvider } from "./useShop-oa7pWA7o.mjs";
...
import { C as Sun, Ft as CircleQuestionMark, G as Phone, Ht as ChevronDown, Kt as ChartColumn, O as ShoppingCart, R as ReceiptText, T as Star, Tt as FileText, Ut as ChefHat, V as QrCode, X as Palette, Yt as Boxes, Z as Package, c as UtensilsCrossed, d as UserCog, gt as Languages, ht as LayoutDashboard, j as Settings, l as Users, n as X, ot as Menu, pt as LogOut, st as Megaphone, tt as Moon, ut as MapPinned, vt as Image, w as Store, x as Tags, yt as Images, zt as ChevronUp } from "../_libs/lucide-react.mjs";
import { n as getToken, r as onMessage, t as getMessagingInWindow } from "../_libs/firebase__messaging.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/route-L38SDEr3.js
...
function AppSidebar({ className, onNavigate }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
						className: "space-y-1",
						children: [
							items.slice(0, 7).map((it) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MobileNavItem, { ...it }, it.to)),
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: restaurantSubItems.map((sub) => {
									const active = loc.pathname === sub.to && loc.hash === sub.hash;
									...
									return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
										...
										className: cn("flex min-h-10 items-center gap-3 rounded-xl px-3 text-sm font-medium", active ? "bg-orange-50 text-orange-600" : "text-slate-600 hover:text-slate-900"),
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SubIcon, { className: "h-4 w-4" }), sub.label]
									}, sub.label);
								})
							})] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "my-3 border-t border-slate-100" }),
							items.slice(7).map((it) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MobileNavItem, { ...it }, it.to))
						]
					}),
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
			className: cn("hidden lg:flex w-24 xl:w-28 shrink-0 flex-col border-r border-[#d8b46b]/50 bg-[#fffaf3] py-4 justify-between", className),
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
				className: "flex-1 flex flex-col gap-6 items-stretch px-0",
				children: [
					items.slice(0, 7).map((it) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavItem, { ...it }, it.to)),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							onClick: () => setRestaurantOpen(!restaurantOpen),
							className: cn("flex flex-col items-center gap-1.5 py-2.5 text-[11px] font-semibold transition-all duration-200 border-l-[3px] w-full text-center relative", loc.pathname.startsWith("/restaurant") ? "border-orange-500 text-orange-600 font-bold" : "border-transparent text-slate-500 hover:text-slate-900"),
							children: [
							...
							children: restaurantSubItems.map((sub) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									...
									hash: sub.hash,
									onClick: () => onNavigate?.(),
									className: cn("flex flex-col items-center gap-1 py-1.5 text-[10px] font-medium transition-all duration-200 w-full text-center relative", active ? "text-orange-600 font-bold" : "text-slate-400 hover:text-slate-700"),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-3/4 mx-auto border-t border-slate-200" }),
					items.slice(7).map((it) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavItem, { ...it }, it.to))
				]
...
function AuthLayout() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShopProvider, {
		value: shopState,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "min-h-screen flex flex-col bg-[radial-gradient(circle_at_top_left,_rgba(182,124,47,0.16),_transparent_30%),_linear-gradient(135deg,_rgba(255,250,243,0.95),_rgba(248,239,228,0.94))]",
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppSidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
						className: "flex-1 overflow-y-auto overflow-x-hidden p-3 pt-16 md:p-6",
