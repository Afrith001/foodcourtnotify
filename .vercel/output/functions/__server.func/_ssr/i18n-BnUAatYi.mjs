import { t as instance$1 } from "../_libs/i18next.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/i18n-BnUAatYi.js
var en = {
	common: {
		appName: "Nexavo POS",
	...
	auth: {
		...
		loginSubtitle: "Sign in to your shop dashboard",
		signupTitle: "Open your shop",
		signupSubtitle: "Get your QR portal in seconds",
		needAccount: "New here? Create a shop",
...
var ta = {
	...
	auth: {
		...
		loginSubtitle: "உங்கள் கடை டாஷ்போர்டில் உள்நுழையவும்",
		signupTitle: "உங்கள் கடையைத் திறக்கவும்",
		signupSubtitle: "QR போர்ட்டலை சில நொடிகளில் பெறுங்கள்",
		needAccount: "புதியவரா? கடை உருவாக்கவும்",
...
if (!instance.isInitialized) {
	if (isBrowser) instance = instance.use(Browser);
...
instance.init({
	...
	lng: isBrowser ? localStorage.getItem("i18nextLng") || void 0 : "en",
	detection: isBrowser ? {
...
var i18n_default = instance$1;
//#endregion
export { i18n_default as t };
